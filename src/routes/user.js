...
userRouter.get('/auth/confirmEmail', AuthController.confirmEmail);
...
userRouter.put('/admin/assignRole', authenticateUser, verifyRoles.verifySupAdmin, AdminCrontroller.assignRole);
userRouter.put('/admin/assignPermission', authenticateUser, verifyRoles.verifySupAdmin, AdminCrontroller.assignPermission);
